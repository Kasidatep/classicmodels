...
<div class="container">
    ...
    <div class="border center" id="invoice">
                    ...
                    <div class="panel panel-default plain" id="dash_0">
                        ...
                        <div class="panel-body p30">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <!-- col-lg-6 start here -->
                                    <div class="invoice-logo"><img width="200px" src="./components/asset/billlogo.png"
                                ...
                                <div class="col-lg-12">
                                        ...
                                        <div class="well">
                                            <ul class="list-unstyled mb0">
                                                ...
                                                <li><strong>Order Date:</strong>
                                                    ...
                                                    <fmt:parseDate value="${orderDate}" var="parsedEmpDateorderDate"
                                                                   pattern="yyyy-MM-dd"/>
                                                    <fmt:formatDate value="${parsedEmpDateorderDate}"
                                                                    pattern="dd MMMMMMMM yyyy"/>
                                                </li>
                                                <li><strong>Require Date:</strong>
                                                    <c:set var="requiredDate" value="${orders.requiredDate}"/>
                                                    <fmt:parseDate value="${requiredDate}"
                                                                   var="parsedEmpDaterequiredDate"
                                                                   pattern="yyyy-MM-dd"/>
                                                    <fmt:formatDate value="${parsedEmpDaterequiredDate}"
                                                                    pattern="dd MMMMMMMM yyyy"/>
                                                </li>
                                                <li><strong>Shipped Date:</strong>
                                                    <c:set var="shippedDate" value="${orders.shippedDate}"/>
                                                    <fmt:parseDate value="${shippedDate}" var="parsedEmpDateshippedDate"
                                                                   pattern="yyyy-MM-dd"/>
                                                    <fmt:formatDate value="${parsedEmpDateshippedDate}"
                                                                    pattern="dd MMMMMMMM yyyy"/>
                                                </li>
                                    ...
                                    <div class="invoice-footer mt25">
                                        <div><strong>Comment: </strong> ${orders.comments}</div>
                                        <div class="row">
                                            <div id="qrcode" class="col-2"> </div>
                                            <div class="col-1"></div>
                                            <div class="col-4"><svg id="barcode"></svg></div>

                                        </div>
                                        <script type="text/javascript">
                                            new QRCode(document.getElementById("qrcode"), "${orders.orderNumber}");
                                            JsBarcode("#barcode", "${orders.orderNumber}");
                                        </script>
